			...
			<nav className="mx-auto flex h-14 w-full max-w-5xl items-center justify-between px-4">
				<div className="flex items-center gap-5">
					...
					<NavigationMenu className="hidden md:flex">
						<NavigationMenuList>
							<NavigationMenuItem>
								<NavigationMenuTrigger className="bg-transparent">Sản phẩm</NavigationMenuTrigger>
							...
							<NavigationMenuItem>
								<NavigationMenuTrigger className="bg-transparent">Công ty</NavigationMenuTrigger>
